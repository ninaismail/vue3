...
<template>
    <section class="flex flex-wrap justify-between w-10/12 h-full gap-6 pt-40 pb-20 mx-auto 2xl:w-8/12 lg:gap-0">
        ...
        <div class="w-full lg:w-5/12">
            <img src="/images_v1/contact/004 1.jpg" alt="Bissar Concepts" width="557" height="558" center cover responsive loading="lazy" class="relative mx-auto transform -scale-x-100 md:ms-auto md:me-0 z-1"/>
        </div>
    </section>
</template>
