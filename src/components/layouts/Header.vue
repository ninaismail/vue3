...
<template>
  <div @mouseover="handleMouseOver" @mouseleave="handleMouseLeave" class="fixed z-[10] inset-0 w-full h-[64px]">
    <header v-show="!isHidden || isMouseOver" role="header" class="py-6 duration-500 bg-white shadow-md max-sm:px-6"
      :class="{'h-fit' : isOpen}">
    <div class="items-center justify-between w-11/12 gap-3 mx-auto space-y-3 2xl:w-8/12 lg:w-10/12 lg:flex">
