...
<template>
  <section class="flex flex-col justify-center w-full h-screen bg-center bg-cover items-between bg-hero">
    <div class="flex flex-col justify-between w-11/12 px-6 mx-auto 2xl:w-8/12 lg:w-10/12 gap-y-2">
    ...
    <Socials class="mx-auto absolute top-[90%] left-[16.67%] transform translate-x-[16.67%]"/>
  </section>
