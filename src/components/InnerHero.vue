...
<template>
  <section class="relative flex flex-col items-center justify-center -mt-[40px] md:min-h-[90vh] min-h-[70vh]">
    ...
    <div class="absolute w-11/12 mx-auto space-y-3 2xl:w-8/12 lg:w-10/12 md:transform md:-translate-y-1/2 md:top-1/2 top-2/3 -translate-y-2/3">
      <h1 class="text-white lg:text-[36px] text-[28px] md:text-[32px] font-[700] text-center">
          {{ pagetitle }}
      </h1>
