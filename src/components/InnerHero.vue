...
<template>
  <section class="relative flex flex-col items-center justify-center mt-[86px] min-h-[70vh]">
    <img :src="pagebanner" :alt="'Bissar Concepts - ' + pagetitle" width="1440" height="639" center cover responsive loading="eager" class="aspect-2.25/1 absolute inset-0 z-[-1] w-full h-full"/>
